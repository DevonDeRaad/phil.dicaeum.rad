...
emp_params = [4.6484, 8.9103, 0.7089, 0.5831, 0.4616, 0.6037, 0.0928]
...
model_fit = Plotting_Functions.Fit_Empirical(fs, pts, prefix, "sim_split_refugia_sym_mig_adjacent", sim_split_refugia_sym_mig_adjacent, emp_params, fs_folded=True)
