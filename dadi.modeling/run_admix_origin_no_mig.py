...
snps = "/u/project/aguillon/dderaad/phil.dicaeum.dadi/reordered.luz.zam.mind.dicaeum.snps.file.txt"
...
#here, pops have been reordered so that pop1=Luzon, pop2=Zamboanga, and pop3=Mindanao(putative hybrid pop)
#this is in contradiction to the split models, where pop1=Luzon, pop2=Mindanao, and pop3=Zamboanga, so that adjacent gene flow models work biogeographically
...
#for these models, the hybrid pop is pop3, which I have now correctly reordered to be mindanao
