...
#SBATCH --chdir=/home/d669d153/work/phil.dicaeum/updated.mito.iqtree  # Set working d$
#SBATCH --mem-per-cpu=2gb            # memory requested
#SBATCH --time=360

#-s specifies the input sequence data
#-p specifies codon partitioned input data
...
/home/d669d153/work/iqtree-2.2.0-Linux/bin/iqtree2 -s Hosner.nd2.with.outgroup.nex -m MFP -bb 1000 -nt AUTO
